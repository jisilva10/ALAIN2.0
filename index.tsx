...
*   **Manos** abiertas listas para construir, facilitar y acompañar procesos.
    ...
    if (isGreeting) {
        ...
        try {
            ...
            if (generateImagePromptMatch) {
                ...
                // Enhance the prompt for more professional, consistent image generation
                const professionalStylePrefix = "Infografía de estilo corporativo, profesional, minimalista, con gráficos limpios y simbólicos sobre un fondo blanco. Representación conceptual sin texto. Calidad fotográfica, 4K, detallado. Representar: ";
                const enhancedPrompt = professionalStylePrefix + originalImageGenPrompt;

                aiMessage.isGeneratingImage = true;
                aiMessage.imagePromptUsed = originalImageGenPrompt; // Keep original prompt for UI display
                ...
                try {
                    const imageResponse = await ai.models.generateImages({
                        ...
                        prompt: enhancedPrompt, // Use the enhanced prompt for the API call
