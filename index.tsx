    ...
    if (chatIdToDelete) {
        ...
        if (currentChatId === chatIdToDelete) {
            ...
            if (userChats.length > 0) {
                // If there are other user chats, load the most recent one.
                ...
                // If the last user chat was deleted, show the welcome screen.
                displayInitialWelcomeMessage();
                // To be consistent with app startup, prompt to create a new chat
                if (newChatModal) {
